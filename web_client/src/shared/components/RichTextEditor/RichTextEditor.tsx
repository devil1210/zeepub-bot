...
const MenuBar = ({ editor }: { editor: any }) => {
    ...
    const placeholders = [
        ...
        { icon: <Type className="w-3 h-3" />, label: 'Inglés', value: 'english_title' },
        { icon: <Type className="w-3 h-3" />, label: 'Español', value: 'spanish_title' },
        ...
        { icon: <Book className="w-3 h-3" />, label: 'Serie (ES)', value: 'series_spanish' },
        { icon: <Book className="w-3 h-3" />, label: 'Serie (EN)', value: 'series_english' },
