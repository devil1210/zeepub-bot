                            ...
                            >
                                ...
                                <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                                    ...
                                    <div className="pt-2 border-t border-white/5 space-y-1.5">
                                        ...
                                        <Link
                                            to={`/app-v2/book/${vol.id || vol.book_hash}`}
                                            className="w-full py-1.5 rounded-xl bg-indigo-600/10 hover:bg-indigo-600 text-indigo-300 hover:text-white text-[11px] font-bold flex items-center justify-center gap-1.5 border border-indigo-500/20 transition-all"
                                        >
                                            <Eye className="w-3.5 h-3.5" /> Ver Ficha del EPUB
                                        </Link>
                                    </div>
                                </div>
                            </div>
