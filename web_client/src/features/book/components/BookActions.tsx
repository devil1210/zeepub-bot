        ...
        <div className="flex flex-col gap-4 w-full">
            {isAdmin && (
                <button
                    ...
                    className="w-full py-4 px-6 bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/20 hover:border-indigo-500/40 rounded-premium-sm flex items-center justify-center gap-4 transition-all group/share shadow-lg mb-2"
                >
            ...
            <button
                onClick={onDownload}
                className={`relative w-full py-4 sm:py-5 rounded-premium text-sm font-black uppercase tracking-[0.25em] flex items-center justify-center gap-3 sm:gap-4 transition-all duration-500 active:scale-95 group overflow-hidden ${hasDownloaded
                    ? 'bg-emerald-500 text-white shadow-emerald-500/30 shadow-lg'
                    : 'bg-primary/90 text-white shadow-premium hover:shadow-glow hover:bg-primary border border-white/5'
                    }`}
            >
                {!hasDownloaded && (
            ...
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-4">
                <button
                    ...
                    className="w-full py-3 sm:py-4 px-4 sm:px-6 glass-panel rounded-premium-sm border border-white/5 hover:bg-white/[0.08] hover:border-white/20 transition-all flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 group/rate shadow-lg"
                >
                ...
                <button
                    ...
                    className="w-full py-3 sm:py-4 px-4 sm:px-6 bg-red-500/5 hover:bg-red-500/10 border border-red-500/10 hover:border-red-500/30 rounded-premium-sm flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 transition-all group/report shadow-lg"
                >
