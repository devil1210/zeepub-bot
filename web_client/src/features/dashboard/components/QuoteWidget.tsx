...
export const QuoteWidget: React.FC<QuoteWidgetProps> = ({ quote, author, settings }) => {
    return (
        <div className="glass-panel p-10 rounded-premium-lg border border-white/5 bg-gradient-to-br from-primary/10 via-transparent to-transparent relative overflow-hidden group shadow-premium">
            ...
            <div
                className="absolute -right-8 -bottom-8 w-32 h-32 bg-primary/5 rounded-premium-full blur-3xl group-hover:scale-150 transition-all duration-1000"
