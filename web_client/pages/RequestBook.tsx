    ...
    <div className="font-sans text-gray-900 dark:text-gray-100 min-h-full animate-in fade-in duration-300 pb-24">
      <main className="max-w-5xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold mb-3 tracking-tight text-gray-900 dark:text-white">Solicitar un Libro</h1>
          ...
          <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/10 flex items-center justify-between group cursor-pointer hover:border-primary/50 transition-colors">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-900 dark:text-white group-hover:text-primary transition-colors">Solicitud Prioritaria</h3>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Sube esta solicitud al principio de la cola</p>
                </div>
              </div>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-black border border-black/5 dark:border-gray-800 shadow-xl dark:shadow-2xl">
          ...
          <div className="relative z-10 p-6 md:p-10 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Apoya a ZeepubBot</h2>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6">
                Somos un proyecto gratuito impulsado por la comunidad. Tus donaciones nos ayudan a mantener servidores, pagar costos de API y <span className="text-gray-900 dark:text-white font-medium">priorizar solicitudes de libros</span> en la cola de procesamiento.
              </p>
