  ...
  return (
    <div className="flex flex-col h-full min-h-0 animate-in fade-in duration-300 relative" ref={scrollContainerRef}>
      ...
      <div className="flex-1 pb-32 md:pb-6 overflow-y-auto">
        ...
        <div className="px-4 max-w-7xl mx-auto space-y-3">
      ...
      < div className="md:hidden fixed bottom-6 left-8 right-8 z-40 flex flex-col gap-3" >
        {isSortMenuOpen && (
          <div
            className="glass-panel rounded-3xl p-3 border border-white/10 animate-in slide-in-from-bottom-2 fade-in duration-200"
            style={{
