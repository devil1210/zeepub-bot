        ...
        <div className="max-w-[1200px] mx-auto w-full flex flex-col gap-8 animate-in fade-in duration-300 px-1 pb-32">
            ...
            < div className="fixed bottom-6 left-8 right-8 z-50 animate-in slide-in-from-bottom-6 duration-500 max-w-7xl mx-auto" >
                ...
                >
                    <button
                        onClick={onBack}
                        className="flex-1 flex flex-col items-center justify-center py-3 rounded-2xl transition-all duration-300 text-gray-500 hover:text-white group"
                    >
                    ...
                    <button
                        onClick={() => setSelectedTierName(tierName)}
                        className="flex-1 flex flex-col items-center justify-center py-3 rounded-2xl transition-all duration-300 text-gray-500 hover:text-white group"
                    >
                        <div className="p-1 rounded-full group-hover:scale-110 transition-transform">
                            <Layers className="w-5 h-5" strokeWidth={2.5} />
                        </div>
                        <span className="text-[9px] font-black uppercase tracking-widest mt-1 opacity-60">Membresía</span>
                    </button>
                    ...
                    <button
                        ...
                        className="flex-1 flex flex-col items-center justify-center py-3 rounded-2xl transition-all duration-300 text-gray-500 hover:text-orange-400 disabled:opacity-20 group"
                    >
                        <div className="p-1 rounded-full group-hover:rotate-[-45deg] transition-transform">
                            <RotateCcw className="w-5 h-5" strokeWidth={2.5} />
                        </div>
                        <span className="text-[9px] font-black uppercase tracking-widest mt-1 opacity-60">Deshacer</span>
                    </button>
                    ...
                    <button
                        ...
                        className="flex-[1.5] flex items-center justify-center gap-3 py-3 rounded-[1.5rem] bg-primary text-white shadow-xl shadow-primary/30 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:grayscale"
                    >
                        {saving ? (
