...
export const SeriesDetail: React.FC<SeriesDetailProps> = ({ series, onBack, onSelectVolume, onSearch }) => {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 relative font-sans text-gray-100">
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4 duration-300 flex flex-col gap-3 w-full max-w-md px-4 md:px-0 md:w-auto">
        {isSortMenuOpen && (
          <div
