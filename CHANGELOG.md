...
- Symlink para comando `update` global en `/usr/bin/update`
- Soporte para Node.js en imagen LXC para compilación de Mini App
- Migraciones de Alembic automáticas en setup
- Herramientas de red (ifupdown) para compatibilidad con Proxmox
- Cliente DHCP y lógica de DNS fallback
