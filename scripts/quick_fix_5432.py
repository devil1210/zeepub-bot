...
def fix():
    try:
        ...
        cur.execute("ALTER TABLE series_metadata ADD COLUMN IF NOT EXISTS spanish_title VARCHAR(255);")

        print("Añadiendo columna series_spanish a series_metadata...")
        cur.execute("ALTER TABLE series_metadata ADD COLUMN IF NOT EXISTS series_spanish VARCHAR(255);")
