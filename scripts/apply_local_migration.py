...
async def apply_local_migration():
    commands = [
        ...
        "ALTER TABLE books ADD COLUMN IF NOT EXISTS jap_title text",
        ...
        "ALTER TABLE books ADD COLUMN IF NOT EXISTS uri_id text",
        "ALTER TABLE books ADD COLUMN IF NOT EXISTS published_at text",
        "ALTER TABLE books ADD COLUMN IF NOT EXISTS modified_at_opf text",
