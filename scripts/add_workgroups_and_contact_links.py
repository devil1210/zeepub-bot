...
async def run_migration():
    ...
    queries = [
        ...
        """,
        # 3. Añadir translator_group_id a series / series_metadata
        """
        ALTER TABLE series ADD COLUMN IF NOT EXISTS translator_group_id INTEGER REFERENCES translators_groups(id) ON DELETE SET NULL;
        """,
        """
        ALTER TABLE series_metadata ADD COLUMN IF NOT EXISTS translator_group_id INTEGER REFERENCES translators_groups(id) ON DELETE SET NULL;
        """,
        # 4. Añadir translator_group_id a books / local_books
        """
