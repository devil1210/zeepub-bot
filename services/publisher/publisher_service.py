                        ...
                        book_data.update(
                            {
                                ...
                                "serie": book.series.series_english if book.series else "",
                                "series_english": book.series.series_english if book.series else "",
                                "romaji_title": book.series.name if book.series else "",
