...
from repositories.library import SeriesRepository, BookRepository
...
class LibraryService:
    ...
    async def get_series_details(self, series_id: str) -> Optional[Series]:
        """Obtiene los detalles completos de una serie."""
        return await self.series_repo.get_by_id(series_id)

    async def get_series_by_slug(self, slug: str) -> Optional[Series]:
