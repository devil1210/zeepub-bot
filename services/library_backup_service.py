...
class LibraryBackupService:
    ...
    def __init__(self, db_path: str, backup_dir: str = "library_backups", max_backups: int = 10):
        """
        Args:
    ...
    def list_backups(self) -> List[dict]:
        ...
        for backup_file in sorted(self.backup_dir.glob("library_backup_*.db*"), reverse=True):
