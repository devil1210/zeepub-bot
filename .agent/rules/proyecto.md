...
# 🌌 Manifesto de Operación ZeePub-bot v3.5.0 (Enterprise)
...
4.  **Calidad y Stack**: Seguir patrones de `python-patterns` y `backend-dev-guidelines`. El stack es **PostgreSQL** para todo (Local y Supabase).
