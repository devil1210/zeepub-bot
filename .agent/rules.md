...
11. **Actualización de Skills**: Verificar periódicamente si existen actualizaciones en el repositorio de skills globales (https://github.com/sickn33/antigravity-awesome-skills/) y reflejar las mejoras pertinentes en `.agent/skills.md`.
