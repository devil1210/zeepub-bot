...
11. **Gestión de Skills**: Mantener el proyecto sincronizado con el repositorio global (https://github.com/sickn33/antigravity-awesome-skills/). Al actualizar, instalar las skills siguiendo el estándar oficial (directorio `.agent/skills/[nombre-skill]/`). Importar selectivamente en `.agent/skills.md` solo aquellas que aporten valor real al desarrollo de Zeepub-bot. Además, definir comportamientos específicos para el uso de estas herramientas en `.agent/skills_rules.md`.
