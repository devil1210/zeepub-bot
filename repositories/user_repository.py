...
class UserRepository(BaseRepository[User]):
    ...
    async def get_access_info(self, telegram_id: int) -> dict[str, Any] | None:
        ...
        level_dict = {
            ...
            "hasAccess": getattr(lvl, "has_mini_app_access", True),
            "dailyDownloads": lvl.daily_downloads if lvl else 5,
            "canDownload": lvl.can_download if lvl else True,
            "canRead": getattr(lvl, "can_read", True),
            "earlyAccess": getattr(lvl, "early_access", False),
            "customThemes": getattr(lvl, "custom_themes", False),
            "price": getattr(lvl, "price", 0),
            "allowThemeTemplates": getattr(lvl, "allow_theme_templates", False),
            "theme": getattr(lvl, "ui_theme", "dark"),
            "primaryColor": getattr(lvl, "ui_primary_color", "#3b82f6"),
            "fontSize": getattr(lvl, "ui_font_size", 14),
            "glassBlur": getattr(lvl, "ui_glass_blur", 12),
            "navOpacity": (getattr(lvl, "ui_nav_opacity", 80) / 100.0),
            "accentOpacity": (getattr(lvl, "ui_accent_opacity", 20) / 100.0),
            "glassOpacity": (getattr(lvl, "panel_transparency", 60) / 100.0),
            "backgroundColor": getattr(lvl, "background_color", "#0f172a"),
            "cardColor": getattr(lvl, "card_color", "#1e293b"),
            "forceSettings": getattr(lvl, "force_settings", False),
