...
try:
    ...
    # Get the series
    series = session.execute(text("SELECT id, series_name, series_hash, book_count FROM series_metadata WHERE series_name ILIKE '%Classroom of the Elite 2nd Year%'")).first()
    if series:
