...
async def repair_database():
    ...
    async with pg_manager.get_session() as session:
        ...
        levels = [
            UserLevel(id=1, name='admin', priority=100, color='#FF5252', price=0, daily_downloads=999, has_mini_app_access=True, early_access=True, custom_themes=True, ui_theme='dark'),
            ...
            UserLevel(id=5, name='white', priority=20, color='#E0E0E0', price=0, daily_downloads=10, has_mini_app_access=True, early_access=False, custom_themes=False, ui_theme='dark'),
            UserLevel(id=6, name='free', priority=10, color='#607D8B', price=0, daily_downloads=5, has_mini_app_access=True, early_access=False, custom_themes=False, ui_theme='dark'),
        ]
